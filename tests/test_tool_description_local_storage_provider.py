...
class TestToolDescriptionLocalStorageProvider:
    ...
    def test_get_description_success(self, tmp_path):
        ...
        provider = ToolDescriptionLocalStorageProvider(descriptions_dir=descriptions_dir)
...
class TestGlobalProviderInstance:
    ...
    def test_global_instance_exists(self):
        ...
        assert isinstance(tool_description_local_storage_provider, ToolDescriptionLocalStorageProvider)
    ...
    def test_global_instance_can_load_real_descriptions(self):
        ...
        try:
            description = tool_description_local_storage_provider.get_description("build_workflow")
    ...
    def test_global_instance_available_tools(self):
        ...
        try:
            available_tools = tool_description_local_storage_provider.get_available_tools()
            assert isinstance(available_tools, list)
            # Should include the main tools we created
            expected_tools = ["build_workflow", "judge_coding_plan", "judge_code_change", "raise_obstacle"]
            for tool in expected_tools:
                if tool not in available_tools:
                    pytest.skip(f"Tool description file for {tool} not found - may be running in test environment")
        except Exception:
