...
def test_judge_response_model():
    ...
    assert approved_response.approved == True
    ...
    assert revision_response.approved == False
    ...
    assert reconstructed.required_improvements == approved_response.required_improvements
